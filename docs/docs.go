            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/stream.StartStreamRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/stream.ResponseSwagStartStreamSuccess"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "stream.ResponseSwagInitSessFail": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "string",
                    "example": "Key: 'InitSessionRequest.Slug' Error:Field validation for 'Slug' failed on the 'required' tag"
                },
                "message": {
                    "type": "string",
